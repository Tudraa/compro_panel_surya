  ...
  return (
    <footer className="w-full bg-[#06131c] text-white pt-0 pb-0 relative overflow-hidden select-none">
      ...
      <div id="contact" className="w-full relative min-h-[360px] md:h-[420px] px-6 sm:px-12 md:px-16 py-16 flex flex-col justify-center items-start gap-6 border-b border-white/10 group overflow-hidden">
        ...
        <div className="relative z-10 max-w-6xl mx-auto w-full space-y-4 text-left">
      ...
      <div className="max-w-6xl mx-auto flex flex-col gap-16 px-6 md:px-16 pt-16">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 gap-10 md:gap-12 pt-4 text-left">
          ...
          <div className="lg:col-span-4 space-y-6">
            ...
            <div className="flex items-center gap-5 pt-2 text-[#00e599]">
              {/* Instagram */}
              <a href="#instagram" aria-label="Instagram" className="hover:text-[#00e599] transition-colors">
              ...
              {/* Facebook */}
              <a href="#facebook" aria-label="Facebook" className="hover:text-[#00e599] transition-colors">
                <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
              ...
              {/* X / Twitter */}
              <a href="#twitter" aria-label="X Twitter" className="hover:text-[#00e599] transition-colors font-bold font-mono text-sm">
                X
              </a>

              {/* LinkedIn */}
              <a href="#linkedin" aria-label="LinkedIn" className="hover:text-[#00e599] transition-colors">
                <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
      ...
      <div className="w-full overflow-hidden pt-6 leading-none">
